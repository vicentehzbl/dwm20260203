...
<body>
    ...
    <main>
        <section class="page-header">
            <div class="container">
                <p class="mb-1">NUESTRA HISTORIA</p>
                <h1 class="fw-bold">Hecho con cariño, servido con sabor.</h1>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        ...
                        <p>Tokyo Noodles nace de la idea de acercar los sabores cotidianos de Japón a una experiencia relajada y cercana.</p>
                        <p>Nos especializamos en ramen y gyozas preparados al momento, cuidando cada ingrediente y buscando que cada visita se sienta como volver a casa.</p>
                    </div>
                    <div class="col-lg-6">
                        <div class="p-5 rounded-4" style="background:var(--periwinkle)">
                            <h3 class="fw-bold">Nuestra misión</h3>
                            <p class="mb-0">Crear bowls reconfortantes y gyozas memorables, combinando tradición japonesa con una identidad moderna y cercana.</p>
                        </div>
                    </div>
                </div>
            </div>
