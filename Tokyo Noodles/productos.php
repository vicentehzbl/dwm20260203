...
<main><section class="page-header"><div class="container"><p class="mb-1">TOKYO NOODLES</p><h1 class="fw-bold">Nuestro menú</h1><p class="mb-0">Ramen, gyozas y combos preparados al momento.</p></div></section>
<section class="py-5"><div class="container">
<div class="row mb-4"><div class="col-md-7"><input id="txtBuscar" class="form-control form-control-lg" placeholder="Buscar ramen, gyozas o combos..."></div></div>
<div id="categorias" class="mb-4"></div>
