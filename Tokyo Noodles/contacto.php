...
<body>
    ...
    <main>
        ...
        <section class="page-header">
            <div class="container">
                <p class="mb-1">ESTAMOS PARA AYUDARTE</p>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-5">
                        <div class="contact-card p-4">
                            <h2>Visítanos</h2>
                            <p>📍 Av. Tokyo 2026, Santiago</p>
                            <p>☎ +56 9 2026 2026</p>
                            <p>✉ hola@tokyonoodles.cl</p>
                            <hr>
                            <p class="mb-0">Lun–Jue 12:00–22:00<br>Vie–Dom 12:00–23:00</p>
                        </div>
                    </div>
                    <!-- FORMULARIO -->
                    <div class="col-lg-7">
                        ...
                        <form id="formContacto">
                            ...
                            <button class="btn btn-tokyo" type="submit">Enviar mensaje</button>
