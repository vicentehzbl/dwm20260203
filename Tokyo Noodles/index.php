...
<section class="info-strip"><div class="container"><div class="row">
...
<div class="d-flex justify-content-between align-items-end mb-4"><div><p class="mb-1 text-secondary">LO MÁS PEDIDO</p><h2 class="section-title">Favoritos de la casa</h2></div><a href="productos.php" class="btn btn-outline-dark">Ver todo</a></div>
<div class="row" id="contenedorProductos"></div>
</div></section>
<section class="py-5"><div class="container"><div class="row g-4">
<div class="col-lg-6"><h2 class="section-title">Opiniones de nuestros clientes</h2>
<div class="review-card p-3 my-3"><strong>★★★★★</strong><p class="mb-1">“El caldo tiene muchísimo sabor y las gyozas están increíbles.”</p><small>— Camila</small></div>
<div class="review-card p-3 my-3"><strong>★★★★★</strong><p class="mb-1">“Un lugar simple, rico y con una atención muy cercana.”</p><small>— Matías</small></div>
<div class="review-card p-3 my-3"><strong>★★★★☆</strong><p class="mb-1">“El combo Tokyo es perfecto para probar un poco de todo.”</p><small>— Fernanda</small></div>
</div>
<div class="col-lg-6"><div class="video-box h-100"><div class="text-center"><div class="video-play mx-auto mb-3">▶</div><h3>Conoce Tokyo Noodles</h3><p class="mb-0">Un vistazo a nuestra cocina.</p></div></div></div>
</div></div></section>
</main>
