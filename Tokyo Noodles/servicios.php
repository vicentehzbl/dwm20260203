...
<main><section class="page-header"><div class="container"><p class="mb-1">MÁS QUE UN RESTAURANTE</p><h1 class="fw-bold">Servicios</h1></div></section>
<section class="py-5"><div class="container"><div class="row g-4">
<div class="col-md-4"><div class="product-card p-4"><h3>🍜 En restaurante</h3><p>Disfruta nuestro menú en un ambiente inspirado en la simpleza y calidez de Tokyo.</p></div></div>
<div class="col-md-4"><div class="product-card p-4"><h3>🥡 Take away</h3><p>Pide tus favoritos para llevar y disfrutar donde quieras.</p></div></div>
<div class="col-md-4"><div class="product-card p-4"><h3>🎉 Eventos</h3><p>Opciones de catering y formatos para celebraciones pequeñas y reuniones.</p></div></div>
